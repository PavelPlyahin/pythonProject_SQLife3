...
u1 = University('Urban')
u1.add_student('Иван', 22)
u1.add_student('Саша', 27)
u1.add_student('Оля', 45)
u1.add_student('Гриша', 47)
u1.add_grade(1, 'Python', 4)
u1.add_grade(1, 'PHP', 5)
u1.add_grade(2, 'Python', 4)
u1.add_grade(2, 'PHP', 4)
u1.add_grade(3, 'Python', 5)
u1.add_grade(3, 'PHP', 3)
u1.add_grade(4, 'Python', 4)
u1.add_grade(4, 'PHP', 4)
